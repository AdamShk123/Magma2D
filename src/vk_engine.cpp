...
void VulkanEngine::createGraphicsPipeline() {
    ...
    fmt::println("{} {}", vertShaderCode.size(), fragShaderCode.size());
...
void VulkanEngine::createImageViews() {
    ...
    for(size_t i = 0; i < swapChainImages.size(); i++) {
        ...
        if(result != VK_SUCCESS) {
            fmt::println("Failed to create image view {}", i);
        }
    }
}
...
SwapChainSupportDetails VulkanEngine::querySwapChainSupport(VkPhysicalDevice pDevice) {
    SwapChainSupportDetails details;
    vkGetPhysicalDeviceSurfaceCapabilitiesKHR(pDevice, surface, &details.capabilities);

    fmt::println("{} {}", details.capabilities.maxImageExtent.width, details.capabilities.maxImageExtent.height);
    fmt::println("{}", details.capabilities.minImageCount);
...
bool VulkanEngine::checkDeviceExtensionSupport(VkPhysicalDevice pDevice) {
